...
// Renamed 2026-08-02, and the name matters. The file's CONTENTS changed on
// 2026-07-24 (the rebrand from "DEE APRIL / PARFUMS" to plain DEE) while the
// URL stayed the same — so every mail client that had already fetched
// /images/logo-white.png kept serving the old wordmark from its cache, and
// buyers were still receiving pre-rebrand emails a week later. A new path is
// the only thing a cache can't second-guess.
export const LOGO_WHITE = "/images/dee-logo-white.png";
export const LOGO_BLACK = "/images/dee-logo-black.png";
