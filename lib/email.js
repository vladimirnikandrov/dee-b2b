...
const PORTAL_URL = process.env.SITE_URL || "https://order.deeapril.com";
...
<img src="${LOGO_WHITE_ABSOLUTE}" alt="Dee April Parfums" width="100" style="display:block;margin:0 auto;height:auto;"/>
</td></tr>
...
const TEMPLATES = {
  ...
  otp_login: (data) => ({
    to: data.email,
    subject: `${data.code} is your Dee April Parfums login code`,
    html: baseLayout(`
  ...
  admin_welcome: (data) => ({
    to: data.email,
    subject: "You've been added as an admin — Dee April Parfums",
    html: baseLayout(`
      ...
      <p style="margin:0 0 24px;font-size:13px;color:#ccc;text-align:center;">You've been given admin access to the Dee April Parfums B2B portal.</p>
      ${divider()}
