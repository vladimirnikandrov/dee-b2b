...
export function getVatInfo(country, vatNumber) {
  ...
  // "moms" is Danish for VAT — the portal, its invoices and its emails are in
  // English, and this note prints on documents the buyer's bookkeeper reads.
  if (isDK) return { rate: DK_VAT_RATE, label: "Danish VAT 25%", note: "Includes 25% Danish VAT" };
