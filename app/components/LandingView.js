    ...
    <div style={{...base,background:"#000",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"40px 20px"}}>
      <div style={{textAlign:"center",maxWidth:520,width:"100%"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          <button className="da-btn" onClick={()=>setView("login")} style={{width:"100%",background: "#fff",color: "#000",border:"none",padding:"16px",borderRadius:12,fontSize:11,fontWeight:600,letterSpacing:"0.15em",textTransform:"uppercase",cursor:"pointer",fontFamily:FONT,animation:"slideUp 0.6s cubic-bezier(0.23,1,0.32,1) 0.45s both"}}>Sign In</button>
          ...
          <button className="da-btn" onClick={()=>setView("adminlogin")} style={{width:"100%",background:"transparent",color:"rgba(255,255,255,0.65)",border:"none",padding:"16px",borderRadius:12,fontSize:10,letterSpacing:"0.15em",textTransform:"uppercase",cursor:"pointer",fontFamily:FONT,animation:"slideUp 0.6s cubic-bezier(0.23,1,0.32,1) 0.65s both"}}>Admin</button>
        </div>
        <div style={{marginTop:40,display:"flex",justifyContent:"center",gap:20}}>
          <a href="/privacy-policy" style={{fontSize:10,color:"rgba(255,255,255,0.6)",textDecoration:"none",letterSpacing:"0.06em"}}>Privacy Policy</a>
          <a href="/eula" style={{fontSize:10,color:"rgba(255,255,255,0.6)",textDecoration:"none",letterSpacing:"0.06em"}}>Terms of Use</a>
          <a href="/dpa" style={{fontSize:10,color:"rgba(255,255,255,0.6)",textDecoration:"none",letterSpacing:"0.06em"}}>DPA</a>
        </div>
      </div>
    </div>
  );
